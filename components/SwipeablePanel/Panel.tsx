...
import { BottomTabDisplayContext } from '../../contexts/BottomTabDisplayContext';
...
type SwipeablePanelState = {
    ...
    deviceHeight: number;
    panelHeight: number;
    ViewOrScrollView: typeof View | typeof ScrollView;
    
};

class SwipeablePanel extends Component<PropsWithChildren<SwipeablePanelProps>, SwipeablePanelState> {
    pan: Animated.ValueXY;
    isClosing: boolean;
    _panResponder: any;
    animatedValueY: number;

    static contextType =  BottomTabDisplayContext
    ...
    componentDidMount = () => {
        const { isActive, openLarge, onlyLarge, onlySmall, noScroll } = this.props;
        if (noScroll) {
            this.setState({ ViewOrScrollView: View });
        }
    ...
    componentDidUpdate(prevProps: SwipeablePanelProps, prevState: SwipeablePanelState) {
        ...
        if (prevProps.noScroll !== this.props.noScroll) {
            if (this.props.noScroll) {
                this.setState({ ViewOrScrollView: View });
            } else {
                this.setState({ ViewOrScrollView: ScrollView });
            }
        }
        ...
        return showComponent ? (
            ...
            >
                ...
                >
                    ...
                    >
                        {/*change true to this state.canScroll to change to original code */}
                        {true ? (
                            <TouchableHighlight>
