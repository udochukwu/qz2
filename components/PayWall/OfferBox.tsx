...
function OfferBox({ subscriptionPeriod, priceString, selected, priceDigit, basePrice, onSelect }: OfferBoxProps) {
        ...
        <Pressable style={{ ...styles.outerContainer, transform: [{ scale: selected ? 1.1 : 1 }] }} onPress={onSelect}>
            ...
            <View style={{ ...styles.container, borderColor: selected ? '#6D56FA' : '#EAEAEA' }}>
                ...
                <View style={styles.bottomContainer}>
                    <Text style={styles.monthly_price}>{monthly_price}</Text>
